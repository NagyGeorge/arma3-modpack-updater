"""Helpers for parsing Arma 3 HTML modlists."""

from bs4 import BeautifulSoup


def parse_arma3_modlist_table(html_path: str) -> list[dict]:
    """Parse an exported Arma 3 HTML mod list."""
    ...
    for row in soup.find_all("tr", attrs={"data-type": "ModContainer"}):
        ...
        if name_tag and link_tag:
            ...
            mod_entries.append({"name": name, "id": mod_id, "url": url})
